...
public class FeedActivity extends AppCompatActivity {
    ...
    //Menüde birşey seçilirse yapılacakları belirtmek için;
    @Override
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.add_post) {
            ...
            startActivity(intentToSignUp); // Çıkış işleminden sonra kullanıcı giriş sayfasına yönlendirmek.
            finish();
        }
